...
public class VerifyActivity extends AppCompatActivity implements ViewTreeObserver.OnGlobalLayoutListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ConfigUtil.setFtOrient(VerifyActivity.this, FaceEngine.ASF_OP_90_ONLY);    //设置人脸优先检测方向
        ...
        showMessageTextView.setText("初始化引擎成功，正在获取人脸数据");


    }

    public void returnResult(boolean isVerify)    //参数记录是否验证成功
    {
    ...
    public void verifyCancelButtonClicked(View view){
        returnResult(false);
    }
    ...
    public void getMyView(){
        showMessageTextView = findViewById(R.id.verify_message_textView);
        previewView = findViewById(R.id.verify_texture_preview);
        faceRectView = findViewById(R.id.verify_face_rect_view);
        showMessageHandler = new Handler(){
            ...
            public void handleMessage(Message msg) {
                if(msg.what == 1){
                    ...
                    showMessageTextView.setText("成功获取人脸数据，开始验证");
                }
            }
        };
    }
